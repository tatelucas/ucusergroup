<div class="um <?php echo $this->get_class( $mode ); ?> um-<?php echo $form_id; ?>">
	...
	<div class="um-form">
		...
		<form method="post" action="">
			...
			<?php  //custom dwl - 9-1-2017 to allow custom notice
			if ( isset( $_REQUEST['skypelocation'] ) && !empty( $_REQUEST['skypelocation'] ) )  {
				echo '<div><p class="um-notice warning">Please select the closest Skype User Group Location and update your account.</p></div>';
			} 
			?>
